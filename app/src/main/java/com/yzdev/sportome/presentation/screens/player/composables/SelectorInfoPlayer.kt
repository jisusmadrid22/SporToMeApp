...
fun SelectorInfoPlayer(
    ...
    Row(
        ...
        CardSelector(isSelected = numberSelector == 3, title = AppResource.getString(R.string.carrer)) {
            onClick(3)
        }

        Spacer(modifier = Modifier.width(4.dp))

        CardSelector(isSelected = numberSelector == 4, title = AppResource.getString(R.string.trophies)) {
            onClick(4)
        }
    }
}
